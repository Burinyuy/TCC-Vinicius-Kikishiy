...
def poseCallback(pose_message):
    ...
    #recebe a orientacao do rbo em quaternios
...
def pick(velocity_publisher, start):
    ...
    for i in range(2):
        ...
        move_to_goal(velocity_publisher,sink[0],sink[1],sink[2]) #define e posicao do proximo percurso
...
def task(start):
    ...
    if start=="go":
        ...
        move_to_goal(velocity_publisher,dinner_table[0],dinner_table[1],dinner_table[2])#define e primeira posicao do percurso
